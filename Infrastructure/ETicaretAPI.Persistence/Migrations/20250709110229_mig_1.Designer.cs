...
namespace ETicaretAPI.Persistence.Migrations
{
    ...
    [Migration("20250709110229_mig_1")]
    partial class mig_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaretAPI.Persisitence.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETicaretAPI.Persisitence.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETicaretAPI.Persisitence.Order", b =>
                {
                    b.HasOne("ETicaretAPI.Persisitence.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("ETicaretAPI.Persisitence.Order", null)
                        .WithMany()
